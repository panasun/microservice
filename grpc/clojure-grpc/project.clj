(defproject clojure-grpc "0.0.1-SNAPSHOT"
  ...
  :profiles
    {:dev {:aliases {"run-dev"
                       ["trampoline" "run" "-m" "clojure-grpc.server/run-dev"]},
           :dependencies [[io.pedestal/pedestal.service-tools "0.5.10"]]},
     :uberjar {:aot [clojure-grpc.server]}}
  :main ^{:skip-aot true} clojure-grpc.server)
